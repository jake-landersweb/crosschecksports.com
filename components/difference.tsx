...
export default function Difference() {
    const cell = (idx: number, title: string, desc: string) => {
        return <div className="grid place-items-center bg-bg backdrop-blur-lg bg-opacity-30 rounded-[20px] p-4">
    ...
    return <div className="space-y-8 md:space-y-10">
        <div className=" grid place-items-center space-y-2 bg-bg backdrop-blur-lg bg-opacity-30 rounded-[20px] p-4">
