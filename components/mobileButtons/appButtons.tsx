...
const AppButtons = () => {
    const cls = "w-full sm:w-auto bg-gray-800 hover:bg-gray-600 transition-all text-white rounded-md inline-flex items-center justify-center px-4 py-2.5"
    return <>
        <div className="p-4 w-full text-center rounded-lg sm:p-8 text-white">
            ...
            <div className="justify-center items-center space-y-4 sm:flex sm:space-y-0 sm:space-x-4">
                <a href="https://apps.apple.com/pk/app/crosscheck-hockey/id1585600361" target="_blank" rel="noopener noreferrer" className={cls}>
                ...
                <a href="https://play.google.com/store/apps/details?id=com.landersweb.pnflutter" target="_blank" rel="noopener noreferrer" className={cls}>
                ...
                <a href="https://teams.crosschecksports.com" target="_blank" rel="noopener noreferrer" className={cls}>
