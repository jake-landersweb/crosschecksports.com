...
const PrivacyPolicy = () => {
    return <BoundsWrapper>
        <div className="space-y-2">
            ...
            <p><a className="hover:opacity-50 transition-opacity" href="#1">1. WHAT INFORMATION DO WE COLLECT?</a><br /><a className="hover:opacity-50 transition-opacity" href="#2">2. HOW DO WE USE YOUR INFORMATION?</a><br /><a className="hover:opacity-50 transition-opacity" href="#3">3. WILL YOUR INFORMATION BE SHARED WITH ANYONE?</a><br /><a className="hover:opacity-50 transition-opacity" href="#4">4. DO WE USE COOKIES AND OTHER TRACKING TECHNOLOGIES?</a><br /><a className="hover:opacity-50 transition-opacity" href="#5">5. IS YOUR INFORMATION TRANSFERRED INTERNATIONALLY?</a><br /><a className="hover:opacity-50 transition-opacity" href="#6">6. WHAT IS OUR STANCE ON THIRD-PARTY WEBSITES?</a><br /><a className="hover:opacity-50 transition-opacity" href="#7">7. HOW LONG DO WE KEEP YOUR INFORMATION?</a><br /><a className="hover:opacity-50 transition-opacity" href="#8">8. HOW DO WE KEEP YOUR INFORMATION SAFE?</a><br /><a className="hover:opacity-50 transition-opacity" href="#9">9. WHAT ARE YOUR PRIVACY RIGHTS?</a><br /><a className="hover:opacity-50 transition-opacity" href="#10">10. CONTROLS FOR DO-NOT-TRACK FEATURES</a><br /><a className="hover:opacity-50 transition-opacity" href="#11">11. DO CALIFORNIA RESIDENTS HAVE SPECIFIC PRIVACY RIGHTS?</a><br /><a className="hover:opacity-50 transition-opacity" href="#12">12. DO WE MAKE UPDATES TO THIS NOTICE?</a><br /><a className="hover:opacity-50 transition-opacity" href="#13">13. HOW CAN YOU CONTACT US ABOUT THIS NOTICE?</a><br /><a className="hover:opacity-50 transition-opacity" href="#14">14. HOW CAN YOU REVIEW, UPDATE OR DELETE THE DATA WE COLLECT FROM YOU?</a></p>

            <h2 id="1" className="text-2xl font-semibold">1. WHAT INFORMATION DO WE COLLECT?</h2>
            ...
            <p>If you use our App, we also collect the following information: Mobile Device Access. We may request access or permission to certain features from your mobile device, including your mobile device&apos;s contacts, storage, and other features. If you wish to change our access or permissions, you may do so in your device&apos;s settings. Push Notifications. We may request to send you push notifications regarding your account or certain features of the App. If you wish to opt-out from receiving these types of communications, you may turn them off in your device&apos;s settings. This information is primarily needed to maintain the security and operation of our App, for troubleshooting and for our internal analytics and reporting purposes.</p>

            <h2 id="2" className="text-2xl font-semibold">2. HOW DO WE USE YOUR INFORMATION?</h2>
            ...
            <h2 id="5" className="text-2xl font-semibold">5. IS YOUR INFORMATION TRANSFERRED INTERNATIONALLY?</h2>
            ...
            <h2 id="6" className="text-2xl font-semibold">6. WHAT IS OUR STANCE ON THIRD-PARTY WEBSITES?</h2>
            ...
            <h2 id="7" className="text-2xl font-semibold">7. HOW LONG DO WE KEEP YOUR INFORMATION?</h2>
            ...
            <h2 id="8" className="text-2xl font-semibold">8. HOW DO WE KEEP YOUR INFORMATION SAFE?</h2>
            ...
            <h2 id="9" className="text-2xl font-semibold">9. WHAT ARE YOUR PRIVACY RIGHTS?</h2>

            <p>In Short: You may review, change, or terminate your account at any time.   If you are a resident in the European Economic Area and you believe we are unlawfully processing your personal information, you also have the right to complain to your local data protection supervisory authority. You can find their contact details here: http://ec.europa.eu/justice/data-protection/bodies/authorities/index_en.htm.</p>
            ...
            <p>If you have questions or comments about your privacy rights, you may email us at support@crosschecksports.com.</p>
            ...
            <p>Opting out of email marketing: You can unsubscribe from our marketing email list at any time by clicking on the unsubscribe link in the emails that we send or by contacting us using the details provided below. You will then be removed from the marketing email list &mdash; however, we may still communicate with you, for example to send you service-related emails that are necessary for the administration and use of your account, to respond to service requests, or for other non-marketing purposes. To otherwise opt-out, you may: Contact us using the contact information provided.</p>

            <h2 id="10" className="text-2xl font-semibold">10. CONTROLS FOR DO-NOT-TRACK FEATURES</h2>
            ...
            <h2 id="11" className="text-2xl font-semibold">11. DO CALIFORNIA RESIDENTS HAVE SPECIFIC PRIVACY RIGHTS?</h2>
            ...
            <h2 id="12" className="text-2xl font-semibold">12. DO WE MAKE UPDATES TO THIS NOTICE?</h2>
            ...
            <h2 id="13" className="text-2xl font-semibold">13. HOW CAN YOU CONTACT US ABOUT THIS NOTICE?</h2>

            <p>If you have questions or comments about this notice, you may contact our Data Protection Officer (DPO), Jake Landers, by email at jake@crosschecksports.com, by phone at 5039262641, or by post to:</p>

            <p>Landersweb LLC Jake Landers 14355 sw racely place tigard, OR 97224 United States</p>

            <h2 id="14" className="text-2xl font-semibold">14. HOW CAN YOU REVIEW, UPDATE, OR DELETE THE DATA WE COLLECT FROM YOU?</h2>
