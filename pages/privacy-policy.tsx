...
Thank you for choosing to use our product, Crosscheck Sports. Here at Sapphire NW, we strive to produce the best quality apps, with data usage and user privacy in mind. If you have any questions or concerns about any of the terms listed in this agreement, please do not hesitate to contact us at success@crosschecksports.com. We will personally read and reply to your message.
...
- **Phone Numbers (optional)**: If you choose to provide your phone number, it will be displayed on your profile. However, please note that we do not use your phone number for any other purposes.
- **Images and Videos**: Our App includes a chat feature and team pages, where users can upload images and videos. These visuals help personalize your interactions and showcase team spirit.
...
- **Analytics**: We track usage data through Google analytics, which anonymously gives us usage information, geographic location data, crash data, and more. Google Analytics is a third-party service and its use of your information is governed by its own privacy policy. We recommend you review this policy for more information.
- **Device Information**: We determine which operating system and device name you use to show you a more seamless app experience in-line with your operating system (i.e. Apple iOS, Google Android). We use device names to give you an easy way to distinguish which device notifications are active.
...
- **User Experience Personalization**: We use your uploaded images and videos to personalize your experience within our chat feature and on team pages.
- **Communication**: With your consent, we send emails and push notifications to your mobile device to provide important app updates, team alerts, game schedules, and other relevant information.
- **Analytics and Improvement**: We use anonymized data collected through Google Analytics to understand how users interact with our app. This helps us identify usage patterns, detect and troubleshoot technical issues, improve app functionalities, and enhance overall user experience.
...
Our app uses cookies, which are small text files stored on your device, to maintain your session when you're logged into our site. This means that you don't have to log in every time you visit our site, providing a smoother, more convenient user experience.

These cookies do not collect any personal information and are not used to track your location or usage information. They are strictly used for session maintenance and expire when you close your browser or logout of your session.

By using our app, you agree to the use of these cookies. You can always disable cookies in your browser settings, but please be aware that some features of our app may not function properly without cookies.
...
If you have any questions or comments about your privacy rights, you may email us at support@crosschecksports.com.
...
If you are under 13, please do not provide any personal information about yourself to us. If we learn that we have collected personal information from a child under age 13 without verifiable parental consent, we will delete that information as quickly as possible. If you believe that we might have any information from a child under 13 without parental consent, please contact us immediately at jake@crosschecksports.com
...
Parents and guardians can review, edit, request the deletion, or prevent further collection or use of their children's personal information or make inquiries regarding this policy by contacting us at jake@crosschecksports.com
...
If you have questions or comments about this notice, you may contact our Data Protection Officer (DPO), Jake Landers, by email at jake@crosschecksports.com, by phone at 5039262641, or by post to:
...
const PrivacyPolicy = () => {
    ...
    return <BoundsWrapper>
        <div className="space-y-2 mb-20">
            ...
            <MarkdownRenderer content={PRIVACY_POLICY} />
        </div>
    </BoundsWrapper>
}
