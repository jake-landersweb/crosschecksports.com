...
export default function AdditionalFeatures() {
    ...
    const cell = (title: string, href: string, icon: JSX.Element, desc: string) => {
        return <div className="flex space-x-4 items-center p-4 rounded-md border border-gray-200">
    ...
    return <div className="space-y-4 bg-bg backdrop-blur-lg bg-opacity-30 rounded-[20px] p-4">
