...
export default function MarkdownRenderer({ content }: { content: string }) {
    ...
    return <div className="">
        <div className="flex flex-row-reverse" data-aos="fade-up" data-aos-offset="200" data-aos-delay="250">
            <div className="hidden md:block rounded-md border border-bg-700 ml-4 sticky inset-x-0 top-[70px] left-0 h-min max-h-[70vh] w-max">
                <div className="overflow-y-scroll max-h-[70vh]">
                    <p className="text-2xl font-bold text-center bg-bg-800 p-2 whitespace-nowrap sticky top-0">Table of Contents</p>
                    <div className="p-4">
                        {getNav()}
                    </div>
                </div>
            ...
            <div className="space-y-4">
                <div className="md:hidden rounded-md border border-bg-700">
                    <p className="text-2xl font-bold text-center bg-bg-800 p-2 whitespace-nowrap sticky top-0 rounded-t-md">Table of Contents</p>
                    <div className="p-4">
                        {getNav()}
                    </div>
                </div>
